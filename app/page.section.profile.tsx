  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className="bg-primary text-primary-foreground font-bold py-2 px-4 rounded mb-2">{AUTHOR.name}</div>
          <div className="bg-black text-white py-1 px-4 rounded text-sm mb-4">{AUTHOR.username}</div>
        </motion.div>

        <div className="flex gap-4">
          <Link href={SOCIAL_LINKS.linkedin.url} target="_blank" rel="noopener noreferrer">
            <Button
              variant="outline"
              size="icon"
              className="rounded-full w-10 h-10 border-2 border-blue-500 hover:bg-blue-50 dark:hover:bg-blue-950"
            >
              <LinkedInLogoIcon className="h-5 w-5 text-blue-500" />
              <span className="sr-only">LinkedIn</span>
            </Button>
          </Link>
          <Link href={SOCIAL_LINKS.youtube.url} target="_blank" rel="noopener noreferrer">
            <Button
              variant="outline"
              size="icon"
        ...
        <div className="space-y-3 font-mono bg-black/5 dark:bg-white/5 p-4 rounded-md border border-border">
          ...
          >
            ...
            <span className="text-foreground">
              I am a software engineer who mainly focused fullstack development and worked devops technologies before.
            </span>
          </motion.div>
          ...
          >
            <span className="text-green-600 dark:text-green-500">$</span>{" "}
            <span className="text-orange-500 dark:text-orange-400">This page contains my development stuff 🔥 🚀</span>
          </motion.div>
          ...
          >
            <span className="text-green-600 dark:text-green-500">$</span>{" "}
            <span className="text-foreground">I write personal stories on my blog below.</span>
          </motion.div>
          ...
          >
            <Link href="/blog" className="group flex items-center text-primary hover:text-primary/80 transition-colors">
